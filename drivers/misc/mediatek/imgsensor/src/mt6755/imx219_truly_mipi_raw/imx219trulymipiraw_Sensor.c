...
#include "imx219trulymipiraw_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "imx219truly_camera_sensor"
#define LOG_1 LOG_INF("imx219truly,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = IMX219_TRULY_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
#define IMX219TRULYMIPI_MaxGainIndex (97)
kal_uint16 IMX219TRULYMIPI_sensorGainMapping[IMX219TRULYMIPI_MaxGainIndex][2] ={
{ 64 ,0  },   
{ 68 ,12 },   
{ 71 ,23 },   
{ 74 ,33 },   
...
{
	kal_uint8 iI;
    LOG_INF("[IMX219TRULYMIPI]enter IMX219TRULYMIPIGain2Reg function\n");
    for (iI = 0; iI < (IMX219TRULYMIPI_MaxGainIndex-1); iI++) 
	{

        if(gain <IMX219TRULYMIPI_sensorGainMapping[iI][0])
		{    
            break;
        }
		if(gain < IMX219TRULYMIPI_sensorGainMapping[iI][0])
		{                
			return IMX219TRULYMIPI_sensorGainMapping[iI][1];       
		}
    ...
    if(gain != IMX219TRULYMIPI_sensorGainMapping[iI][0])
    {
         LOG_INF("Gain mapping don't correctly:%d %d \n", gain, IMX219TRULYMIPI_sensorGainMapping[iI][0]);
    }
	LOG_INF("exit IMX219TRULYMIPIGain2Reg function\n");
    return IMX219TRULYMIPI_sensorGainMapping[iI-1][1];
	//return NONE;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
   ...
   if (CAM_8M_ID != 1) 
	{
		LOG_INF("IMX219 CAM_8M_ID = %d, it is IMX219 main source\n", CAM_8M_ID);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
