...
static const UINT_16 g_u2CountryGroup5[] = {
	...
	COUNTRY_CODE_BE, COUNTRY_CODE_BA, COUNTRY_CODE_VG,
...
static const UINT_16 g_u2CountryGroup16[] = {
	...
	COUNTRY_CODE_FK, COUNTRY_CODE_MX, COUNTRY_CODE_MZ,
	COUNTRY_CODE_NA, COUNTRY_CODE_LC, COUNTRY_CODE_VC,
	COUNTRY_CODE_UZ, COUNTRY_CODE_ZW
};
...
DOMAIN_INFO_ENTRY arSupportedRegDomains[] = {
	...
	,
	{
	 /* Russia, Belarus, Kazakhstan and Ukraine 5GHz customization */
	 (PUINT_16) g_u2CountryGroup21, sizeof(g_u2CountryGroup21) / 2,
	 {
	  ...
	  , 			/* CH_SET_UNII_MID_52_64 */
	  { 121, BAND_5G, CHNL_SPAN_20, 132, 3, FALSE }
...
{
#define REG_DOMAIN_DEF_IDX             22 /* Default regulatory domain */
